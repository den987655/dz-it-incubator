...
function Clock() {
    ...
    const stringDate = date.toLocaleDateString('ru-RU', { day: 'numeric', month: 'numeric', year: 'numeric' }) || <br/> // день.месяц.год (01.02.2022) // пишут студенты, варианты 01.02.0123/01.02.-123/01.02.12345 не рассматриваем
